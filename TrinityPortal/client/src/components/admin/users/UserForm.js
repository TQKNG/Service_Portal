        ...
        if (Password !== Password2) {
          ...
          if (parseInt(UserTypeID) === 2) {
            data = {
              ...
              Email: `${
                FirstName + LastName + SchoolID + Math.floor(Math.random() * 1000)
              }@mail.com`,
            };
          }
          addUser(data).then(() => {
  ...
  return (
    <div className="p-sm-5 p-2 w-100  dashboard-margin mx-lg-auto container">
      ...
      >
        <Alert />
        <div className="mb-3">
          <div className="txt-primary">AlternativeID</div>
          <input
            type="text"
        ...
        <div className="mb-3">
          ...
          >
            ...
            {authUser.UserTypeID === 5 && (
              <option value={6}>Admin{`(VP, P)`}</option>
            )}
            {authUser.UserTypeID === 5 && (
        ...
        {/* Logic: If the role is Admin, can select more than one school */}
          ...
          UserTypeID !== "5" && (
            <div className="mb-3">
              ...
              <MultiSelectWithCheckboxes
                id="Schools"
                value={Schools}
                optionsList={schoolsList?.map((school) => ({
