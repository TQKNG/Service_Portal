...
const Setting = ({
  ...
  const [formData, setFormData] = useState({
    volumeMin1:  settingsList === null ? 0 : settingsList.Volume !== undefined ?  settingsList.Volume['9am-5pm'].min : 0,
    volumeMax1: settingsList === null ? 0 : settingsList.Volume !== undefined ?  settingsList.Volume['9am-5pm'].max : 0,
    volumeMin2:settingsList === null ? 0 : settingsList.Volume !== undefined ?  settingsList.Volume['5pm-9am'].min : 0,
    volumeMax2: settingsList === null ? 0 : settingsList.Volume !== undefined ?  settingsList.Volume['5pm-9am'].max : 0,
    language: "",
    roles: settingsList === null ? [] : settingsList.Roles!== undefined ?  settingsList.Roles : [],
    emails:[],
    outbreakStatus: settingsList === null ? 0 : settingsList.OutbreakStatus !== undefined ?  settingsList.OutbreakStatus : 0,
    outbreakMessage1:  settingsList === null ? "" : settingsList.OutbreakMessage !== undefined ?  settingsList.OutbreakMessage.outBreakMessage1 : "",
    outbreakMessage2: settingsList === null ? "" : settingsList.OutbreakMessage !== undefined ?  settingsList.OutbreakMessage.outBreakMessage2 : "",
  });
      ...
      {settingsList === null ? (
        ...
        <div className="p-sm-5 p-2 w-100 dashboard-margin">
          ...
          <div className="card w-100 p-2 p-sm-3 p-lg-5 shadow-lg border-0 users-list d-flex justify-content-between overflow-y-auto overflow-x-hidden">
            <form className="w-100 d-flex flex-column gap-5" onSubmit={(e) => onSubmit(e)}>
              <div className="row">
                {/* General Settings */}
